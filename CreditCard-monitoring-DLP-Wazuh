# Add credit card DLP monitoring with Wazuh
## Reglas
...
Al momento de guardar los cambios en este archivo en el servidor, el cambio se refleja en todos los agentes y se reinicia el servicio automaticamente para aplicar los cambios.
...
Esto sucede cuando los archivos a escanear o revisar son demasiados. Por eso lo acote poniendo los tipos de archivos especificos que queria monitorear en la expresion regular.
...
Donde exponen como configurar para detectar SSN
...
Bueno primero fui a la documentacion de Wazuh, con respecto a la parte de regex:
https://documentation.wazuh.com/2.0/user-manual/ruleset/ruleset-xml-syntax/regex.html
Supongo que alguien mas experimentado si le entiende, pero yo no logre formar las regex con esa info, asi que me fui al origen:
https://github.com/ossec/ossec-hids/tree/master/src/os_regex
